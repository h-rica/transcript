...
use crate::{
    components::{
        app_ui::{ActionButton, LinkButton, MetricCard},
...
pub fn TranscriptionScreen() -> impl IntoView {
    ...
    view! {
        <WorkspaceShell route=WorkspaceRoute::Transcription>
            ...
            >
                <Badge variant="outline">{move || shell.active_model.get()}</Badge>
            </WorkspaceHeader>
                        ...
                        <Card class="border-zinc-800 bg-[#191919] text-zinc-50">
                            <CardHeader class="space-y-4">
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <Badge variant="secondary">{move || status_label(&session.status.get())}</Badge>
                                </div>
                            </CardHeader>
                        ...
                        <section class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                            <Card class="border-zinc-800 bg-[#191919] text-zinc-50">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        "Segments append here while the local decoder emits progress and diarization updates."
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <LiveSegmentList
                            ...
                            <div class="flex flex-col gap-6">
                                <Card class="border-zinc-800 bg-[#191919] text-zinc-50">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            "Completion metrics stay visible before you switch into transcript review."
                                        </CardDescription>
                                    </CardHeader>
...
fn speed_label(session: &TranscriptionSessionState) -> String {
    ...
    format!("{:.2}x · ETA {}", rtfx, format_elapsed(remaining))
}
